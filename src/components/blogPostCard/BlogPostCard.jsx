              ...
              {getAllBlog.map((item, index) => {
                ...
                return (
                  <div className="p-4 md:w-1/3" key={index}>
                    ...
                    >
                      {/* Blog Thumbnail  */}
                      <img style={{backgroundRepeat:"cover" }} onClick={() => navigate(`/bloginfo/${id}`)} className=" w-full h-60" src={thumbnail} alt="blog" />
                      {/* Top Items  */}
                      <div className="p-6">
                        {/* Blog Date  */}
                        ...
                        <p className="title-font text-sm  text-gray-900 mb-3" style={{
                          color: mode === 'dark'
                            ? 'rgb(226, 232, 240)'
                            : ' rgb(30, 41, 59)'
                        }}>
